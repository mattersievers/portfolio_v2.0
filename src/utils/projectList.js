const projects = [
    {
      ...
      technology:"MERN/Stripe/Leaflet",
      description:"Track and recover lost musical equipment. Users can create individual accounts where they can document their current musical equipment and report it lost at any time. The homepage loads a list of lost equipment along with filters to help narrow results and get equipment returned to the rightful owner.",
